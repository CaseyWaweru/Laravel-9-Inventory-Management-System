        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> {{ number_format($semesterincomes) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-bank text-info"></i> {{ number_format($monthlybalance) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-paper text-success"></i> {{ number_format($semesterexpenses) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
